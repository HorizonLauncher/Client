...
void Library::init(QSettings* p)
{
    ...
    QPixmap search(":/res/icon/Material/Search.svg");
    ...
    QPixmap grid(":/res/icon/Material/LibGridView.svg");
    QIcon gridIcon(grid);
    QPixmap listImg(":/res/icon/Material/LibDetailedListView.svg");
    QIcon listIcon(listImg);
    QPixmap carousel(":/res/icon/Material/LibCarouselView.svg");
